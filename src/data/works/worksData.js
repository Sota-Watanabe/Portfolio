export const worksData = [
  {
    ...
    description:
      "XenonTextという名前のプログラミングエディタを3人で制作しました。複数のタブやコードのハイライト、保存や上書き保存など1通りの機能は利用できます。これは僕の制作物の中で1番完成度が高いものになり、自信作です。\nエディタの部分はace-editorというJavaScript製のテキストエディタを利用しています。\n\nリリースページなどもあるので是非ご覧ください。",
  ...
  },
  {
    ...
    description:
      "学部時代の卒業研究について紹介するサイトです。具体的には卒業研究の梗概と卒業論文、最終発表に利用した発表資料を公開してあります。\nこのサイトを作成した理由は3つあります。\n1つは自分の卒業研究を公開したかったからです。大学生活の1年間という時間を丸々使った研究であり、賞も受賞できたということで満足のいく研究だったと思います。\n2つ目の理由として、Vue.jsを触ってみたかったというのがあります。Vue.jsはReactとの違いが多々あって面白かったです。Reactと違ってHTMLとJSがしっかり別れているのがいいですね。今回使ったのはVue2でしたので次はVue3に挑戦してみたいと思います。\n3つ目はAWSを使ってみたかったからです。AWSにはいろんなサービスがあってとても便利ですね。今回は「静的ウェブサイトをサブドメインで公開」してみました。（詳細はブログをご覧ください）これからはもっとAWSを使いたいと思います。",
  ...
  },
  {
    ...
    description:
      "大学のイベントで作成したものです。\nプログラミングキーボードを押すと、ピアノの鍵盤が動きます。大学でDisklavierという自動演奏ピアノを使って何かを作れと言われてので作ってみました。\nプログラミングキーボードのキーが押すと、midi信号をピアノに送り、ピアノを動かしています。また「SIT in Tamachi」と入力すると某コンビニ曲が弾けるようなモードも作成してみました。\n詳細はブログとGitHubの方に書きましたのでどうぞご覧ください。",
